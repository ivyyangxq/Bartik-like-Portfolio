...
data_CEE <- data %>% dplyr::select( "USSTHPI", "SP500")

# Select the rest of the variables for another dataset
data_rest <- data %>% dplyr::select(-c("USSTHPI", "SP500",  "year", "month", "day"))
```
...
highly_correlated_CEE <- find_highly_correlated(data_CEE, threshold = 0.99)  # Check for high correlations
print(highly_correlated_CEE)  # This will show if any columns are highly correlated
```
...
save(CCA_time_series, file = "/Users/ivyyang/Dropbox/cloud/Research/Research 2023/Chapter 1/Data/CCA_time_series_Bartik.rds")

write.csv(CCA_time_series, file = "/Users/ivyyang/Dropbox/cloud/Research/Research 2023/Chapter 1/Data/CCA_time_series_Bartik.csv")
```
...
# On DELL
# Save the CCA time series data
save(CCA_time_series, file = "C:/Users/ivyyang/Dropbox/cloud/Research/Research 2023/Chapter 1/Data/CCA_time_series_Bartik.rds")

write.csv(CCA_time_series, file = "C:/Users/ivyyang/Dropbox/cloud/Research/Research 2023/Chapter 1/Data/CCA_time_series_Bartik.csv")
```
```
